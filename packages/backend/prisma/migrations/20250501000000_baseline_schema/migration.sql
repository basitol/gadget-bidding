...
CREATE INDEX IF NOT EXISTS idx_user_verifications_code ON user_verifications(verification_code) WHERE is_verified = false;
...
CREATE INDEX IF NOT EXISTS idx_payment_transactions_gateway_ref ON payment_transactions(gateway_reference) WHERE gateway_reference IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_gadget_categories_slug ON gadget_categories(slug);
CREATE INDEX IF NOT EXISTS idx_gadget_categories_active ON gadget_categories(is_active) WHERE is_active = true;
...
CREATE INDEX IF NOT EXISTS idx_gadgets_seller ON gadgets(seller_id, status);
CREATE INDEX IF NOT EXISTS idx_gadgets_category ON gadgets(category_id);
CREATE INDEX IF NOT EXISTS idx_gadgets_status ON gadgets(status);
CREATE INDEX IF NOT EXISTS idx_gadgets_search ON gadgets USING gin(to_tsvector('english', title || ' ' || description));
...
CREATE INDEX IF NOT EXISTS idx_auctions_status ON auctions(status, start_time, end_time);
CREATE INDEX IF NOT EXISTS idx_auctions_active ON auctions(status) WHERE status = 'active';
...
CREATE INDEX IF NOT EXISTS idx_bids_bidder ON bids(bidder_id, bid_time DESC);
...
CREATE INDEX IF NOT EXISTS idx_bid_holds_wallet ON bid_holds(wallet_id, status);
CREATE INDEX IF NOT EXISTS idx_bid_holds_bid ON bid_holds(bid_id);
...
CREATE INDEX IF NOT EXISTS idx_orders_seller ON orders(seller_id, fulfillment_status);
CREATE INDEX IF NOT EXISTS idx_orders_order_number ON orders(order_number);
CREATE INDEX IF NOT EXISTS idx_orders_payout ON orders(payout_status, fulfillment_status);
...
DROP TRIGGER IF EXISTS update_gadgets_updated_at ON gadgets;
